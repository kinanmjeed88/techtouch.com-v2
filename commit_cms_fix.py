...
if tree_items:
    ...
    new_commit_sha = create_commit("fix: correct CMS categories tab loading issues and HTML structure", new_tree_sha, [latest_commit_sha])
    update_ref("main", new_commit_sha)
    print("Successfully pushed fixes for CMS categories tab.")
else:

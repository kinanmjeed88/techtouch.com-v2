...
if tree_items:
    ...
    new_commit_sha = create_commit("fix: strip HTML from keywords/tags and normalize title font sizes", new_tree_sha, [latest_commit_sha])
    update_ref("main", new_commit_sha)
    print("Successfully pushed fixes for tags and title fonts.")
else:
